...
<body>
    ...
    <!-- 
        ...
        - type 속성 : 여러가지 입력양식을 선택함
            ...
            - for속성 : input 요소의 id명과 같아서 라벨 클릭시 입력요소로 포커스가 자동으로 들어간다
